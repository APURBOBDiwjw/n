...
IN_BTTS = [
    [
        Button.url(
            "Owner",
            url="https://t.me/Xenpaicc",
        ),
        Button.url("Support", url="https://t.me/Xenpai_ccworld"),
    ]
]
...
<b>Owner</b>: <a href="https://t.me/Xenpaicc">Xenpaicc</a>
<b>Support</b>: <a href="https://t.me/Xenpai_ccworld">Xenpaicc</a>
<b>Chat</b>: <a href="https://t.me/Xenpai_ccworld">Chat</a>
(c) XteamBD
"""
                res = [
...
def callback(data=None, from_users=[], owner=False, **kwargs):
    ...
    def ultr(func):
        async def wrapper(event):
            ...
            elif owner and event.sender_id != 5195866238:
