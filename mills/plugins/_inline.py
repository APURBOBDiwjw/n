...
SUP_BUTTONS = [
    [
        Button.url("• channal •", url="https://t.me/Xenpai_ccworld"),
        Button.url("• Support •", url="t.me/Xenpai_ccworld"),
    ],
    [
...
HELP_BUTTONS = [
    [
        Button.url("• Owner •", url="https://t.me/Xenpai_ccworld"),
        ...
        result = await event.builder.article(
            ...
            buttons=[
                [
                    ...
                    Button.url("Channel", url="t.me/Xenpai_ccworld"),
                ],
            ],
        )
        await event.answer([result])
